...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://d52ne38ocf.execute-api.us-east-1.amazonaws.com/k1';
    ...
    apigClient.getUploadUrlPost = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var getUploadUrlPostRequest = {
            verb: 'post'.toUpperCase(),
            path: pathComponent + uritemplate('/get-upload-url').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
        ...
        return apiGatewayClient.makeRequest(getUploadUrlPostRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.getUploadUrlOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var getUploadUrlOptionsRequest = {
        ...
        return apiGatewayClient.makeRequest(getUploadUrlOptionsRequest, authType, additionalParams, config.apiKey);
    };
